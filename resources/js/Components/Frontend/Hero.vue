...
<template>
  ...
  >
    ...
    >
      <div class="flex flex-col md:flex-row items-center h-full pt-28">
        <div class="flex-1 flex flex-col items-center lg:items-start">
          <p class="text-lg text-accent text-md mb-[22px]">Hey, I'm Boy! 👋</p>
          <h1
            class="
              text-4xl
              leading-[44px]
          ...
          <button
            class="
              btn btn-md
              bg-accent
              hover:bg-light-tail-500 hover:text-white
        ...
        <div class="flex flex-1 justify-center items-center h-full mt-8 md:mt-0 ">
          <img
            class="h-[65vh] shadow-lg rounded-3xl my-12"
            src="http://laravel-portfolio.test/img/WaterColor1.jpg"
            alt="Hero"
          />
        </div>
      </div>
