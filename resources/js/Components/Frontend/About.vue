  ...
  <section id="about" class="section bg-light-secondary dark:bg-dark-secondary">
    ...
    >
      <div class="flex flex-col xl:flex-row gap-24">
        <img
          class="object-cover h-full w-[566px] shadow-2xl md:mx-auto lg:mx-0 rounded-2xl"
          src="http://laravel-portfolio.test/img/about.png"
          alt="about"
        />
        <div
          class="
        ...
        >
          <div class="flex flex-col">
            ...
            <P class="mb-4 text-slate-900">Freelance frontend Web developer</P>
